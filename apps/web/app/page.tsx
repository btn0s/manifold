            ...
            <div className="mx-auto max-w-5xl text-center">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="gap-2 text-base px-8" asChild>
                  <a href="https://www.raycast.com/btn0s/manifold-linear" target="_blank" rel="noopener noreferrer">
                    Install Extension
          ...
          <div className="bg-card rounded-2xl shadow-xl border p-8 sm:p-12">
            <div className="grid gap-8 lg:grid-cols-2 items-center">
              ...
              <div className="relative">
                ...
                <div className="relative bg-background/50 backdrop-blur border rounded-xl p-6 space-y-4">
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="group relative overflow-hidden rounded-xl border bg-card p-6 hover:shadow-lg transition-shadow">
              <div className="mb-4">
